...
Zum Schluss soll noch ein Button zum Abschluss der Stimmenabgabe zur Verfügung stehen.
...
=== Ramenbedingungen
* anonyme Wahl
* Eine Stimme/Schüler*in
* Einbindung in Schulnetzwerk
* Betreuung durch Systemadministrator
