...
Die Ziele vom Projekt: 
    ...
    - Das derzeitge Schulwahlsystem der HTL Leonding sollte digitalisiert werden, da Lehrkräfe sowie SchülerInnen Probleme haben das Wahlsystem zu verstehen.

    - Damit man Fehler bei der Berechnung der Stimmen um 90% vermindert, wird eine Rechenmaschine verwendet. 

    - Da es bei der Schulwahl zu ungültigen Wahlergebnissen kommen kann, werden die Punkte digital in eigenen Feldern zur Auswahl stehen.
