...
Ressourcen die der Auftraggeber zur Verfügung stellt: 
 ...
 - Daten (sonstige Aufwendungen): Klassenzuordnungen, Identifikationsnummer aller Lehrkräfte, Liste von Schüler:innen ,die sich für die Schülerinnenvertretung aufstellen
